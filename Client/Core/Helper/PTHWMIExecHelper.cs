...
namespace xClient.Core.Helper
{
    class PTHWMIExecHelper
    {
        ...
        public static OrderedDictionary GetPacketRPCAuth3(byte[] packet_NTLMSSP)
        {
            //4 extra bytes?
        ...
        public static OrderedDictionary GetPacketRPCAlterContext(byte[] packet_assoc_group, byte[] packet_call_ID, byte[] packet_context_ID, byte[] packet_interface_UUID)
        {
        ...
        public static OrderedDictionary GetPacketNTLMSSPVerifier(int packet_auth_padding, byte[] packet_auth_level, byte[] packet_sequence_number)
        {
        ...
        public static OrderedDictionary GetPacketDCOMRemQueryInterface(byte[] packet_causality_ID, byte[] packet_IPID, byte[] packet_IID)
        {
        ...
        public static OrderedDictionary GetPacketDCOMRemRelease(byte[] packet_causality_ID, byte[] packet_IPID, byte[] packet_IPID2)
        {
        ...
        public static OrderedDictionary GetPacketDCOMRemoteCreateInstance(byte[] packet_causality_ID, string packet_target)
        {
