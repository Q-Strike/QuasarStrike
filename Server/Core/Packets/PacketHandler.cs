...
namespace xServer.Core.Packets
{
    public static class PacketHandler
    {
        public static void HandlePacket(Client client, IPacket packet)
        {
            ...
            else if (type == typeof(ClientPackets.GetMessageResponse))
            {
                //Return chat from agent
                CommandHandler.HandleGetMessageResponse((ClientPackets.GetMessageResponse)packet, client);
            }
            else if (type == typeof(ClientPackets.GetStopChatAgent))
            {
