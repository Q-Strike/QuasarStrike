...
namespace xServer.Forms
{
    public partial class FrmSystemInformation : Form
    {
        ...
        {
            QuasarServer.writeLog("Refreshing System Information", _connectClient.Value.PCName);
            ...
            if (_connectClient != null)
            {
                ...
                if (_connectClient.Value != null)
                {
                    ...
                    lstSystem.Items.Add(lvi);
                    QuasarServer.writeLog("Gathering more information...", _connectClient.Value.PCName);
                    lvi = new ListViewItem(new string[] { "", "Getting more information..." });
                    lstSystem.Items.Add(lvi);
                }
            }
