...
namespace xServer.Forms
{
    public partial class FrmBuilder : Form
    {
        ...
        private void FrmBuilder_Load(object sender, EventArgs e)
        {
            ...
            {
                //These two items may be required by the module.
                if(typeDef.FullName != "<Module>" || typeDef.FullName.Contains("PrivateImplementationDetails"))
                {
                lstModules.Items.Add(typeDef.FullName);
                }
        ...
        private BuildOptions ValidateInput()
        {
            ...
            if (chkBoxLightAgent.Checked)
            {
                options.LightAgent = true;
            }
