...
namespace xServer.Forms
{
    public partial class FrmRegistryEditor : Form
    {
        ...
        private void createStringRegistryValue_Click(object sender, EventArgs e)
        {
            ...
            {
                QuasarServer.writeLog("Creating Registry Key Values at " +tvRegistryDirectory.SelectedNode.FullPath + " (STRING)", _connectClient.Value.PCName);
        ...
        private void createBinaryRegistryValue_Click(object sender, EventArgs e)
        {
            if (tvRegistryDirectory.SelectedNode != null)
            {
                QuasarServer.writeLog("Creating Registry Key Values at " + tvRegistryDirectory.SelectedNode.FullPath + " (BINARY)", _connectClient.Value.PCName);
        ...
        private void createDwordRegistryValue_Click(object sender, EventArgs e)
        {
            if (tvRegistryDirectory.SelectedNode != null)
            {
                QuasarServer.writeLog("Creating Registry Key Values at " + tvRegistryDirectory.SelectedNode.FullPath + " (DWORD)", _connectClient.Value.PCName);
        ...
        private void createQwordRegistryValue_Click(object sender, EventArgs e)
        {
            if (tvRegistryDirectory.SelectedNode != null)
            {
                QuasarServer.writeLog("Creating Registry Key Values at " + tvRegistryDirectory.SelectedNode.FullPath + " (QWODR)", _connectClient.Value.PCName);
        ...
        private void createMultiStringRegistryValue_Click(object sender, EventArgs e)
        {
            if (tvRegistryDirectory.SelectedNode != null)
            {
                QuasarServer.writeLog("Creating Registry Key Values at " + tvRegistryDirectory.SelectedNode.FullPath + " (MULTISTRING)", _connectClient.Value.PCName);
