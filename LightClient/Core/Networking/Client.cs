...
using xLightClient.Core.Compression;
using xLightClient.Core.Cryptography;
using xLightClient.Core.Extensions;
using xLightClient.Core.NetSerializer;
using xLightClient.Core.Packets;
using xLightClient.Core.ReverseProxy;
using xLightClient.Core.ReverseProxy.Packets;

namespace xLightClient.Core.Networking
{
    public class Client
    {
        /// <summary>
